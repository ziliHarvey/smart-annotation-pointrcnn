...
parser.add_argument('-json', type=str, default="Guest.PC_315978406019574000.json", help="specify the annotation file")
parser.add_argument('-data', type=str, default="PC_315978406019574000.ply", help="specify point cloud file")
